...
$productos = "SELECT * FROM productos WHERE Id_producto = 12";
...
<body>
    ...
    <br>
    <div class="producto">
        <br><br><img src="Guayaba.png" width="350px" height="280px">
        <div class="info">
            <h4>Vendidos:</h4>
        ...
        <div class="info">
            ...
            <h2>Cantidad:</h2>
            <center><form class="formulario" action="Vista12.php" method="POST">
                <input type="hidden" name="txtProducto" value="Pulpa de Guayaba">
