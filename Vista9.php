...
$productos = "SELECT * FROM productos WHERE Id_producto = 9";
...
<head>
    ...
    <title>Nutripulp: Horchata</title>
...
<body>
    ...
    <br>
    <div class="producto">
        <br><br><img src="Horchata.png" width="350px" height="280px">
        <div class="info">
            <h4>Vendidos:</h4>
        ...
        <div class="info">
            ...
            <h2>Cantidad:</h2>
            <center><form class="formulario" action="Vista9.php" method="POST">
                <input type="hidden" name="txtProducto" value="Pulpa de Horchata">
